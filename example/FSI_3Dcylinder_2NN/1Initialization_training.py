...
@physicsnemo.sym.main(config_path="conf", config_name="conf_initial")
def run(cfg: PhysicsNeMoConfig) -> None:
    ...
    # Interior NS PDE: set lambda_ns = 0, i.e., remove the PDE residual term from the loss first and train the boundary conditions only.
